...
DEFAULT_RUBRICS = r"""
To evaluate search results effectively, think like a professional rater using a structured approach. Your goal is to assess each result’s quality based on its ability to meet user needs, focusing on the following key factors that you are asked below on Content Appropriateness. Follow these instructions:
...
#### 8\. Content Appropriateness Evaluation

Prompt:

"Evaluate the given content and determine if it should be classified as pornographic based on the following evaluation criteria. Your goal is to assess whether the content contains explicit material and if it should be flagged as pornographic (Porn) or not pornographic (Not Porn).

Evaluation Criteria:

Explicit Sexual Content:
    * Does the page contain sexually explicit images, videos, or written descriptions intended for sexual gratification?
    * Example of Pornographic Content: A website with nude or sexually explicit imagery, erotic videos, or adult-themed sexual stories.
    * Example of Not Pornographic Content: A medical article discussing human anatomy with clinical illustrations.
Sexually Suggestive Content:
    * Does the page include sexually suggestive but non-explicit material, such as provocative images, innuendos, or discussions of sexual activities?
    * Example of Pornographic Content: Websites that feature erotic roleplay stories, softcore images, or provocative adult-themed advertisements.
    * Example of Not Pornographic Content: An article discussing romantic relationships or a lingerie advertisement without explicit nudity.
Porn Advertisements & Pop-ups:
    * Does the page contain pop-ups, banners, or redirects to pornographic sites?
    * Example of Pornographic Content: A webpage with links or ads leading to explicit adult content or cam sites.
    * Example of Not Pornographic Content: A webpage that mentions adult websites in a neutral or educational context without linking to them.
Sexually Explicit Search Intent:
    * If the query explicitly seeks pornography, assess whether the page meets the expectation of delivering adult content.
    * Example of Pornographic Content: A page that contains erotic images or videos when the query explicitly asks for pornographic material.
    * Example of Not Pornographic Content: A webpage that mistakenly appears in search results but does not contain explicit adult content.
...
Evaluation Levels: Unless specified otherwise, use the following scale to classify evaluation levels.
    * Low (1-2):  The page contains explicit sexual content, sexually suggestive material, or links to pornography.
    * Medium (3-5): The page contains content that is not explicitly pornographic but includes material that is sexually suggestive or provocative. This may include partial nudity, innuendo, or content that implies sexual themes or situations without being overtly explicit. The intent of the content may be to attract or titillate, but it stops short of explicit sexual acts or direct pornography. 
    * High (6-7): The page does not contain explicit adult content or is focused on education, health, or relationships without an intent to provide sexual gratification.
...
def main(
    ...
    output_path: str = "/tmp/dump_feather_results/graded_search_result_groups_dump_Rel_SamplewC_ContentAppro_nv4_wC.jsonl",

...
"Given the following webpage content, determine whether it qualifies as a High Stake page. A High Stakepage is one that can significantly impact a person’s health, financial stability, safety, or well-being. Specifically, evaluate whether the content falls under any of the following High Stake categories.

Evaluation Criteria:

* Health or Safety: Medical advice, drugs, hospitals, emergency preparedness, or mental health.
* Financial Stability: Investments, loans, banking, taxes, or personal finance.
* Legal or Government Information: Voting, legal rights, public policies, or laws.
* News and Current Events: Political, scientific, or global developments that affect society.
* Shopping and Commerce: Financial transactions, product reviews, or e-commerce decisions. 
* Groups of People: Information about race, ethnicity, religion, age, gender, or disability that could influence fairness or discrimination.
...
Evaluation Levels: Unless specified otherwise, use the following scale to classify evaluation levels.
    * Low (1-2): If the page does not significantly impact a person's well-being in these ways.
    * Medium (3-5): Generally considered high stake but context of the query and content does not clearly classify them as impacting personal's well being significantly.
    * High (6-7): If the page falls under any of these categories.
...
def main(
    ...
    output_path: str = "/tmp/dump_feather_results/graded_search_result_groups_dump_Rel_SamplewC_HighStakes_nv4_woC.jsonl",

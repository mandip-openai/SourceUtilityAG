...
"Evaluate the user experience based on clarity, accessibility, and usability.

Evaluation Criteria:

Is the content easy to read and understand?
    Example of high readability: A result with clear headings, concise paragraphs, and bulleted lists.
    Example of low readability: A poorly formatted page with dense, unstructured text.
Does the site design enhance usability?
    Example of high usability: A well-designed, responsive site with easy navigation and functioning links.
    Example of low usability: A site cluttered with intrusive ads or broken links.
Is the content engaging and accessible?
    Check for multimedia, interactivity, and accessibility features.
Hidden Text & Links: 
    Are there elements intended to manipulate rankings without user visibility?
Keyword Stuffing: 
    Does the page unnaturally repeat keywords to manipulate search rankings?
Link Spam: 
    Are links excessively placed for ranking manipulation rather than for user benefit?
Machine-Generated Traffic: 
    Does the site engage in automated queries or scraping without consent?
Misleading Functionality: 
    Does the site falsely claim to offer content or services it does not provide?
Scaled Content Abuse: 
    Is the site generating a large volume of low-value, AI-generated, or scraped content?
Scraping & Duplicate Content: 
    Does it copy content from other sources without meaningful additions?
Sneaky Redirects: Are users redirected to different content than what was initially displayed?
Site Reputation Abuse: 
    Is the page hosted on a reputable domain but unrelated to the site’s core purpose?
Thin Affiliates: 
    Does it promote affiliate links without unique or valuable content?
User-Generated Spam: 
    Is the page filled with spammy comments, low-quality user content, or fake forum posts?
...
Evaluation Levels: Unless specified otherwise, use the following scale to classify evaluation levels.
    * Low (1-2): Result is poorly designed, difficult to navigate, or inaccessible. The page violates multiple spam policies and provides little to no user value.
    * Medium (3-5): Result is somewhat usable but has minor issues in design or accessibility. The page has some suspicious elements but does not fully meet spam criteria.
    * High (6-7): Result is well-organized, visually appealing, and highly user-friendly. The page is genuine, transparent, and does not engage in deceptive ranking manipulation.
...
def main(
    ...
    output_path: str = "/tmp/dump_feather_results/graded_search_result_groups_dump_Rel_SamplewC_UXSpam_nv4_wC.jsonl",

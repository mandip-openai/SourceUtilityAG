...
#### 4\. Geographic & Cultural Relevance Evaluation

Prompt:

"Assess the geographic and cultural relevance of the given content based on its alignment with the user and query’s regional or cultural context. Evaluate whether the source provides appropriate, localized, and culturally accurate information for the intended audience.

Evaluation Criteria:

Local Authority & Expertise 
    * Does the content come from a trusted local source, official institution, or recognized regional expert?
Cultural Sensitivity & Nuance 
    * Does the content reflect cultural norms, linguistic accuracy, and context-appropriate examples?
Applicability to Region-Specific Queries 
    * For queries requiring local knowledge (e.g., laws, healthcare, government policies, traditions, businesses), does the source provide accurate, location-specific insights?
Comparison to Generic Content 
    * Is the content tailored to the intended locale, or is it overly broad, missing key regional details, or misrepresenting cultural aspects?
Potential for Misinformation 
    * Does the content incorrectly apply foreign standards, use misleading cultural stereotypes, or present irrelevant regional details?
...
Evaluation Levels: Unless specified otherwise, use the following scale to classify evaluation levels: 
    * Low (1-2): Content is generic, inappropriate, or misaligned with the geographic or cultural expectations of the query.
    * Medium (3-5):  Some regional or cultural adaptation, but lacks depth or specificity (e.g., global sources with minor local references).
    * High (6-7): Source demonstrates deep local expertise, cultural nuance, or authoritative regional knowledge (e.g., government sites, local news, community experts).
...
def main(
    ...
    output_path: str = "/tmp/dump_feather_results/graded_search_result_groups_dump_Rel_SamplewC_GeoCult_nv4_wC.jsonl",

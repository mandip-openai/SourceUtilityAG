...
DEFAULT_RUBRICS = r"""
To evaluate search results effectively, think like a professional rater using a structured approach. Your goal is to assess each result’s quality based on its ability to meet user needs, focusing on the following key factors that you are asked below on Source Trustworthiness. Follow these instructions:
...
#### 10\. Source Trustworthiness Evaluation

Prompt:

"Analyze the given webpage and assess its overall Source Trustworthiness Rating based on the following four key criteria. Assign a rating of Low, Medium, or High and provide a clear justification for your decision. Consider the context of the page and its potential impact on users, especially for high Stakes topics where Trust is critical.

Evaluation Criteria:

Reputation of the Content Creator
    * Identify whether the content creator is a business, website, organization, individual, or online community.
    * Evaluate external reputation signals such as awards, endorsements, expert citations, user reviews, or news coverage.
    * Look for negative reviews, controversies, past misinformation, or evidence of low credibility.
    * Examples:
        * High Reputation: A well-known medical journal publishing peer-reviewed research.
        * Low Reputation: A website with many scam reports and negative user reviews.
Title of the Page
    * Assess whether the title accurately reflects the content and if it is misleading, exaggerated, or sensationalized.
    * Determine if the title sets the right expectations and matches the main content's purpose.
    * Examples:
        * Good Title: "How to Invest in Stocks: A Beginner’s Guide" → Accurately describes investment basics.
        * Bad Title: "This Stock Will Make You a Millionaire Overnight!" → Misleading and sensational.
Main Content Evaluation
    * Identify the core topic of the main content and determine whether it achieves its intended purpose.
    * Evaluate if the page provides in-depth, well-researched, and original content, or if it is shallow, copied, or poorly written.
    * Consider if the content is well-structured, easy to read, and visually appealing, or cluttered with ads and distractions.
    * Examples:
        * High-Quality Main Content: A detailed health guide written by medical professionals, citing reliable sources.
        * Low-Quality Main Content: A poorly written, auto-generated article with no real expertise or depth.
Experience, Expertise, Authoritativeness, and Trust
    * Consider if the content creator demonstrates first-hand experience in the topic.
    * Evaluate if the author or website possesses credentials or knowledge that makes them a reliable source.
    * Determine if the website or content creator is a go-to source for this type of information.
    * Assess if the content is accurate, well-sourced, and unbiased, or if it contains misleading, deceptive, or false information.
    * Examples:
        * High Level: A financial advice page from a government agency or a leading investment firm.
        * Low Level: A health blog promoting unverified medical treatments with no expert sources.

Instruction: Provide a rating in the scale 1-7 with a brief justification based on these criteria.

Evaluation Levels: Unless specified otherwise, use the following scale to classify evaluation levels.
    * Low (1-2):  The page is evaluated as failing to meet expectations, having low trust, misleading content, poor reputation, or lacking depth. It may be potentially harmful if misleading, especially for High Stakes topics.
    * Medium (3-5): The page is evaluated as somewhat useful but lacks depth, credibility, or clear trust signals. Improvements could be made with better sources, structure, or expertise.
    * High (6-7): The page is evaluated as well-written, reputable, accurate, and highly useful for its intended purpose, with strong indicators of experience, expertise, authoritativeness, and trust.
...
def main(
    ...
    output_path: str = "/tmp/dump_feather_results/graded_search_result_groups_dump_Rel_SamplewC_SourceTrust_nv4_wC.jsonl",
